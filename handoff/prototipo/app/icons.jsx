/* ============================================================
   Iconos — set de líneas propio (stroke 1.75)
...
(function () {
  const P = {
    ...
    fire: 'M12 3c1 3-1.5 4-1.5 6.5a3.5 3.5 0 0 0 7 0c0-1-.3-1.8-.7-2.5 2 1.2 3.2 3.4 3.2 5.8a6 6 0 0 1-12 0c0-3.3 2-6 4-9.8ZM10.5 18.5a2.5 2.5 0 0 0 3 0',
    star: 'M12 3.5l2.6 5.3 5.9.85-4.25 4.15 1 5.85L12 16.9l-5.25 2.8 1-5.85L3.5 9.65l5.9-.85L12 3.5Z',
    ...
    rocket: 'M5 15c-1 1-1.5 4-1.5 4s3-.5 4-1.5M14 6c3-3 6-3 6-3s0 3-3 6l-4.5 4.5-4-4L14 6ZM9 11l-3 1 1 3M15 9.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z',
    info: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-9v4m0-7.5h.01',
    bus: 'M5 16V6a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10M4 16h16M4 16v2h2v-2M18 16v2h2v-2M4 11h16M8 19v1M16 19v1',
  };

  function Icon({ name, size = 20, stroke = 1.75, color = 'currentColor', fill = 'none', style, ...rest }) {
    const d = P[name];
    if (!d) return null;
