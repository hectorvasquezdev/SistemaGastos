export default function Icon({ name, size = 20, stroke = 1.75, color = 'currentColor', fill = 'none', style, ...rest }) {
  const paths = {
    ...
    palette:  'M12 21a9 9 0 0 1 0-18c4.97 0 9 3.58 9 8 0 2.21-1.79 4-4 4h-2.5a1 1 0 0 0-.8 1.6 1.1 1.1 0 0 1-1.7 1.4zM7 12a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3-4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm4 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z',
  };
  const d = paths[name];
  if (!d) return null;
  return (
